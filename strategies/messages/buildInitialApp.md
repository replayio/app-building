...
```
npx tsx /repo/scripts/add-task.ts --strategy "strategies/tasks/build/testSpec.md" --subtask "Unpack: Write test specification" --trailing
npx tsx /repo/scripts/add-task.ts --strategy "strategies/tasks/build/writeApp.md" --subtask "Unpack: Write the app" --trailing
npx tsx /repo/scripts/add-task.ts --strategy "strategies/tasks/writeScript.md" --subtask "Unpack: Implement package scripts" --trailing
npx tsx /repo/scripts/add-task.ts --strategy "strategies/tasks/build/writeTests.md" --subtask "Unpack: Write Playwright tests" --trailing
npx tsx /repo/scripts/add-task.ts --strategy "strategies/tasks/build/testing.md" --subtask "Unpack: Get all tests passing" --trailing
