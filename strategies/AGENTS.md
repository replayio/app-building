...
- **mergeStrategies.md**: Merge infrastructure changes (code, strategies, config) from an app branch back to `main` without merging the apps themselves. Works in a `*-merge` branch.
